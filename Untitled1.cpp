...
void delete_item();
 ...
 main(void)
 {
	...
	int diff,tm;
	char p[100]="admin",u[100]="admin",ch;
	char i;int j=0;
	printf("\nENTER USERNAME ");
	...
	psword[j]='\0';
	if(strcmp(psword,"admin")==0 && strcmp(user,"admin")==0)
		{
 	int ch;
 	do{
	printf("\n####################################################################");
	printf("\n");
	printf("\t AMBER BAKERY - INFOMATION SYSTEM ");
	printf("\n");
	printf("\n###################################################################\n");
	printf("[1] Search to Insert item\n");
	printf("[2] Search aLL items\n");
	printf("[3] Search find Order name, item no.\n");
	printf("[4] Search Order item\n");
	printf("[5] Search bill\n");
	printf("[6] Search bill by bill number or name\n");
	printf("[7] Search delete items \n");
	printf("[8] Information about the Bakery \n");
	printf("\nPress <0> Exit ");
